  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center overflow-x-hidden mt-10">
        <div className="flex flex-col items-start justify-between w-full max-w-[1121px] h-[276px] lg:gap-6">
          <h1 className="text-[21px] font-[500] leading-[41px] text-left max-w-[910px] h-[78px] md:text-5xl md:font-medium">
          ...
          <p className="text-start text-base font-normal max-w-[834px] h-[78px] mb-6">
            Our collection features timeless fashion, with natural fabrics, elegant silhouettes, and classic designs
            that can elevate any wardrobe. Each piece enchants with its sophistication, made to last for generations,
            blending the essence of past eras with a modern touch.
          </p>
        </div>

        <div className="flex flex-col md:flex-row items-center w-full max-w-[1119px] lg:h-[413px] gap-0">
          <img src={slider} alt="Contact Us" className="w-full md:w-1/2 h-full object-cover" />
          <div className="flex flex-col justify-center flex-1 p-8 bg-color-grayish lg:h-[413px]">
            <div className="w-[452] h-[164] m-4">
              <h1 className="font-medium text-4xl mb-4">About Us</h1>
              <p className="font-normal text-base mb-6">
                UrbanNest is a fashion store based in Struga, Macedonia. Established in 2024, by Nikola Ristoski. <br />
                Our dedicated customer service team is always ready to support you 24/7.
              </p>
            </div>
            <Link to="/home" className="ml-4 text-color-black border-b border-black text-base font-medium flex items-center w-32">
              Shop Now <img src={shoparrow} className="ml-2" alt="arrow" />
            </Link>
          </div>
        </div>

        <div className="flex flex-col items-center justify-center w-full max-w-[1120px] h-auto lg:gap-10 mt-5">
          ...
          <div className="flex flex-col md:flex-row justify-between w-full h-auto">
            <div className="bg-color-grayish p-4 flex-1 min-w-[250px] h-[130px] flex flex-col items-center justify-between mx-2 mb-4 md:mb-0">
